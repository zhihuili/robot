...
import com.nana.serviceengine.dao.webapi.impl.WeatherAPI;
...
import com.nana.serviceengine.neuron.responsecreator.impl.WeatherSentenceCreator;
...
public class WeatherServiceProcessor extends ServiceProcessor {
	...
	private void finalDealRequest(UserMessage mes, WeatherParam wParam) {
		...
		// TODO SEND MSG
		RobotResponser.getInstance().responseMessage(WeatherSentenceCreator.getInstance()
				.createSentence(params), mes);
